    ...
    .then(function (response) {
      return {
        cosmic: {
          ...
          global: .keyBy(.filter(response.data.data.getObjects.objects, { type: 'globals' }), 'slug')
        }
      }
    })
              ...
              return (
                 <div className="card" data-href={`/posts/${post.id}`} key={post.id}>
                  ...
                  <div className="card-padding">
                    <h2 className="blog_title blog_title--small">
                    ...
                    <div className="blog_teaser droid" dangerouslySetInnerHTML={{_html: post.metadata.teaser}}></div>
